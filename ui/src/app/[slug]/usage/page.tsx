                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="w-[300px]">
                                <TimezoneSelect
                                    ...
                                    placeholder={preferencesLoading ? t('loading') : t('selectTimezone')}
                                    styles={{
                                        control: (base, state) => ({
                                            ...base,
                                            minHeight: '36px',
                ...
                <Card className="mb-6">
                    ...
                    <CardContent>
                        {isLoadingCredits ? (
                            ...
                            <p className="text-muted-foreground">{t('noServiceKeys')}</p>
                        )}
                    </CardContent>
                </Card>
                            ...
                            <>
                                    ...
                                    <Table>
                                        <TableHeader>
                                            <TableRow className="bg-muted/50">
                                                ...
                                                <TableHead className="font-semibold text-end">{t('columnDuration')}</TableHead>
                                        ...
                                        <TableBody>
                                            {usageHistory.runs.map((run) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell>{run.workflow_name || t('unknownAgent')}</TableCell>
                                                    <TableCell>
                                    ...
                                    <div className="mt-4 p-3 bg-muted rounded-md">
                                        <p className="text-sm text-muted-foreground">
                                            {t('totalForFilteredPeriod')} <span className="font-semibold text-foreground">
                                                {usageHistory.total_dograh_tokens.toLocaleString()} {t('dograhTokensSuffix')}
                                            </span>
                                            {' • '}
                                ...
                                {usageHistory.total_pages > 1 && (
                                    <div className="flex items-center justify-between mt-6">
                                        <p className="text-sm text-muted-foreground">
                                            {t('pageInfo', { page: usageHistory.page, totalPages: usageHistory.total_pages, totalCount: usageHistory.total_count })}
                                        </p>
